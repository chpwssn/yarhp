...
class Configuration extends React.Component<props, state> {
    ...
    public setRedditMulti = (e: any) => {
        this.props.updateOptions({ ...this.props.options, reddit_multi: e.target.value })
    }
    ...
    public render() {
        return (
            <div className="configuration">
                ...
                <label htmlFor="reddit">Subreddits to display (blank for "best"):</label>
                <input type="text" id="reddit" value={this.props.options.reddit_multi} onChange={this.setRedditMulti}></input><br />
            </div>
        );
    }
}
